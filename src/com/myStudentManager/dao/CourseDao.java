package com.myStudentManager.dao;
...
//				cm.setCourse_info(rs.getString("course_info"));
	 ...
	 * @return
	 */
	public boolean addCourse(String course_name,int course_credit,String course_begin_time,int teach_id){
		String sql = "insert into c_course(course_name,course_credit,course_begin_time,teach_id) values('"+course_name+"',"+course_credit+",'"+course_begin_time+"',"+teach_id+")";
		return DBConnection.update(sql)==true?true:false;
	}
	public boolean modifyCourse(int course_id, String course_name, int course_credit, int teach_id, String course_begin_time){
		String sql = "update c_course set course_name='"+course_name+"',course_credit="+course_credit +"',teach_id="+teach_id + ",course_begin_time='"+course_begin_time+"' where course_id="+course_id;
		return DBConnection.update(sql)==true?true:false;
	}
}
