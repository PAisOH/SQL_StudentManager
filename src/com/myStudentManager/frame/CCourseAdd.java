...
import com.myStudentManager.dao.ClassDao;
import com.myStudentManager.dao.CourseDao;
import com.myStudentManager.dao.GradeDao;
import com.myStudentManager.dao.StudentDao;
import com.myStudentManager.model.CCourseModel;
import com.myStudentManager.model.ClassModel;
import com.myStudentManager.model.CourseModel;
import com.myStudentManager.model.GradeModel;
import com.myStudentManager.model.StudentModel;
	...
	void flashTextArea() {
		...
		List<CCourseModel> lists = ccd.getListsByStuId(stu_id);
			...
			for(int i=0;i<lists.size();i++){
				...
				jTextArea_ccourse.append(course_id+"."+course_name);
