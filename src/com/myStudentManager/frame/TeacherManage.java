...
public class TeacherManage extends JDialog {
	...
	private void initialize() {
		...
		jLabel_teach_educatioon.setText("系部门：");
...
//		jContentPane.setBorder(BorderFactory.createTitledBorder("操作一体化"));
	...
	public void initData() {
		...
		String heads[] = { "授课教师ID", "授课教师姓名", "教师性别", "系部门"};
		model = new DefaultTableModel(null, heads);
		jComboBox_teach_education.addItem("CS");
		jComboBox_teach_education.addItem("IS");
		jComboBox_teach_education.addItem("MA");
